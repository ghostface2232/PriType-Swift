...
- 한자 후보창이 macOS 컨텍스트 메뉴와 같은 모습이 됐습니다. 전에는 뒤의 창이 흐린 회색으로 비쳐 탁해 보였습니다. 원인은 재질이 아니었습니다: 입력기의 창은 활성 앱이 될 수 없어서 Liquid Glass가 늘 비활성 창의 모습(회색 막)으로 그려졌습니다. 시스템 메뉴 창이 하는 것처럼 활성 모습으로 그리게 해, 같은 배경 위에서 실제 메뉴와 구분되지 않게 맞췄습니다. 행 사이 구분선과 번호의 회색 원을 없애고 여백·글꼴을 메뉴에 맞췄습니다. 오른쪽의 발음 표시도 없앴습니다. 한자는 한 글자가 한 음절이라 후보의 글자 수가 바꿀 범위를 이미 보여 주고(大韓民國·民國·國), 뜻풀이에도 발음이 들어 있습니다. 다만 사전에서 음절 수와 한자 글자 수가 다른 52개 항목(가가와현 → 香川縣 등, 대부분 뜻풀이 없음)은 선택하면 발음 전체를 바꾸므로 발음을 계속 보여 줍니다. 한 글자 후보의 한자를 가운데 대신 왼쪽에 맞춰, 大韓民國 같은 여러 글자 후보와 시작 위치가 같게 했습니다. 다크 모드도 메뉴를 따릅니다.
